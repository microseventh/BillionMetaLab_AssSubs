...
202304 | 03 | 我的百合乃工作是也！<br>营业百合 | [Click](https://drive.google.com/drive/folders/1KnSFtEKMKIDxezybI2_K9KRNhR55IMRN?usp=sharing) | 简体、繁体字幕
202304 | - | 绊之Allele | 之后再说 | 占坑
 | |  |  | 
...
202210 | 03 | [孤独摇滚](https://github.com/MingYSub/SubArchive/tree/main/Archive/Bocchi%20the%20Rock%21) (**与MingYSub联合制作**) | （略） | 暂时开摆<br>仅发布BD
 | |  |  |
...
[Subtitle_Language] | 即番剧的字幕语言<br>[CHS]、[CHT]分别表示简体、繁体的内嵌字幕；<br>[CHS&JPN]表示简日双语内嵌字幕；<br>[CHT&JPN]表示繁日双语内嵌字幕；<br><br>[CHS&CHS]表示仅有简体内封；<br>[CHT&CHT]表示仅有繁体内封；<br><br>[CHS&CHT]表示简繁内封字幕；<br>[CHS&CHT&JPN]表示简繁日内封字幕
[Else] | 即番剧的其它信息，包括但不限于是否修正、发布版本之类的；<br>第一次发布默认不写出；<br>修正版本一般为[Revision]、二次修正为[Revision][2]，以此类推
