...
| :----: | :----------: | :-----------------------------------------------------------------------------------------------------------------------: | :----------: | :------: |
| 202601 |      06      |           [日本三国](./202604/日本三国/)（与[三明治摆烂组](https://t.me/smzase_sub)联合制作）             |      /      |  简繁日  |
| 202604 |      06      |           [魔法姐妹露露莉莉](./202604/魔法姐妹露露莉莉)            |      /      |  简繁日  |
| 202601 |      01-12(END)      |                                         反转·血色百合「名称太长这里放不下」                                         |      /      |  简繁日  |
| 202507 |      09      |                                  [保龄球少女](./202507/Turkey!/) 三连全中Turkey!                                  | 同字幕路径下 |  简繁日  |
| 202507 |  06（END）  |                                            [章鱼噼的原罪](./202507/章鱼噼的原罪/)                                            | 同字幕路径下 |  简繁日  |
| 202504 |  12（END）  |            mono 女孩（与 [MingYSub](https://github.com/MingYSub/SubsArchive/releases/tag/202504) 联合制作）            |      /      |  简繁日  |
| 202503 |    moive    |                                    [你的颜色](./202501/Kimi%20no%20iro/)  きみの色                                    | 同字幕路径下 |   简日   |
| 202407 |  00-17(END)  |                          [双重四亡·恶魔毁灭](./202407/双重四亡·恶魔毁灭/)「DDDD 恶魔的破坏」                          | 同字幕路径下 |  简繁日  |
|        |              |                                                                                                                          |              |          |
...
| [Episode]           | 即番剧的集数，一般用多用两位数字表示，不足位数的用0代替；合集一般用[aa-xx]表示，aa表示最初一集的集数，xx表示最后一集的集数                                                                                                                                                                                                                                           |
| [Resolution]        | 即番剧的分辨率，一般为1920*1080，故常用[1080p]本组根据实际情况，选择性压制720p分辨率的视频                                                                                                                                                                                                                                                                           |
| [Coding]            | 即番剧的视频编码，默认采用[x264 8bit]的压制格式[HEVC 10bit]表示采用[x265 10bit]的压制方式[AV1 10bit]表示采用[AV1 10bit]压制方式，想要了解更多关于AV1编码的知识，可以[点击这里](https://github.com/microseventh/BML_Full_Process#%E7%AC%AC%E5%85%AD%E9%83%A8%E5%88%86%E5%8E%8B%E5%88%B6)                                                                       |
| [Audio=]            | 即番剧的配音语言默认为日语配音[Audio=Japanese]，不会写出；其他例如[Audio=Chinese]表示中文配音                                                                                                                                                                                                                                                                    |
| [Subtitle_Language] | 即番剧的字幕语言[CHS]    或    [简体中文]    表示简体内嵌字幕[CHT]    或    [繁体中文]    表示繁体内嵌字幕；[CHS&JPN]    或    [简日内嵌]    表示简日双语内嵌字幕[CHT&JPN]    或    [繁日内嵌]    表示繁日双语内嵌字幕；[CHS&CHT]    或    [简繁内封]    表示简繁内封字幕；[CHS&CHT&JPN]    或    [简繁日内封]    表示简繁日内封字幕 |
